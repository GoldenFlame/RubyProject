TaskThree::Application.routes.draw do
  ...
  match "fight/area/:area" => "fight#area", :as => "fight_wilds"
  match "avatar/equip/:item" => "avatar#equip"
  match "avatar/disequip" => "avatar#disequip"
  match "fight/attack" => "fight#attack"
  match "fight/skill" => "fight#skill"
  match "fight/heal" => "fight#heal"
  match "fight/check_fight_end" => "fight#check_fight_end", :as => "check_fight_end"
  match "cities/arena" => "cities#arena", :as => "arena"
